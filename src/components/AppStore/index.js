...
class AppStore extends Component {
  ...
  updateActiveCategory = category => {
    this.setState({activeCategory: category, isTrue: true})
  }
  ...
  render() {
    ...
    const filteredAppList = this.updatedListAppStore()

    const filteredSearchInput = filteredAppList.filter(eachAppDetails =>
      eachAppDetails.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )

    const filteredList = isTrue ? filteredAppList : filteredSearchInput
    ...
    return (
      <div className="main-div">
        ...
        <div className="app-div-container">
          <ul className="app-ul-el">
            {filteredList.map(eachAppDetails => (
              <AppItem
